...
<div class="wrapper s-conteiner">
    ...
    <div class="row price-list__box">
        <div class="col col-lg-12">
            <h1>Прайс-лист</h1>
        </div>
        <div class="price-list__header">Прием специалистов</div>
        <div class="price-list__title">Терапевт</div> <div class="price-list__value">550/450</div>
        <div class="price-list__title">Акушер гинеколог</div> <div class="price-list__value">650/500</div>
        <div class="price-list__title">Уролог</div> <div class="price-list__value">600/500</div>
        <div class="price-list__title">Проктолог</div> <div class="price-list__value">700</div>
        <div class="price-list__title">Травматолог-ортопед</div> <div class="price-list__value">600/500</div>
        <div class="price-list__title">Эндокринолог</div> <div class="price-list__value">550/450</div>
        <div class="price-list__title">Ревматолог</div> <div class="price-list__value">600/500</div>
        <div class="price-list__title">Нефролог</div> <div class="price-list__value">600/500</div>
        <div class="price-list__title">Кардиолог</div> <div class="price-list__value">750/600</div>
        <div class="price-list__title">Маммолог-онколог</div> <div class="price-list__value">600/500</div>
        <div class="price-list__title">Невролог</div> <div class="price-list__value">600/500</div>
        <div class="price-list__title">Гастроэнтеролог</div> <div class="price-list__value">650/550</div>
        <div class="price-list__title">Гепатолог-инфекционист</div> <div class="price-list__value">800/650</div>
    </div>
        <div class="row contacts-box">
            <div class="col col-lg-4 col-md-12 contacts-box__contacts">
                ...
                <p class="contacts-box__podzagolovok"> e-mail: <a href="mailto:info@500303.ru" class="link">info@500303.ru</a>
                </p>
